...
- `allowed_callers`: Optional list of known callers with `name`, E.164 `phone_numbers`, and Home Assistant `ha_user_id`. Legacy single-value `phone_number` entries still work. Allowed callers can also be managed from the add-on admin UI.
